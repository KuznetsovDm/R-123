...
{
    public class AudioProxyProvider
    {
        ...
        public void InitListener(AudioListener listener)
        {
            if (listener == null)
                throw new Exception("Audio listnere should be not null.");
            ...
            this.listener.AudioDataAvailableEvent += Listener_AudioDataAvailableEvent;
        }
