...
namespace R123.Radio.ViewModel
{
    class Frequency : View.ContinuouslyRotating
    {
        public Frequency()
        {
            ...
            SetBinding(RequestEndRotateCommandProperty, new Binding("RequestEndRotateFrequency"));
    ...
    class Volume : View.ContinuouslyRotating
    {
        public Volume()
        {
            ...
            SetBinding(RequestEndRotateCommandProperty, new Binding("RequestEndRotateVolume"));
    ...
    class Noise : View.ContinuouslyRotating
    {
        public Noise()
        {
            ...
            SetBinding(RequestEndRotateCommandProperty, new Binding("RequestEndRotateNoise"));
    ...
    class Antenna : View.ContinuouslyRotating
    {
        ...
        public Antenna()
        {
            ...
            SetBinding(RequestEndRotateCommandProperty, new Binding("RequestEndRotateAntenna"));
            MouseMoveFactor = 0;
        }
        public override void TestRequestRotateCommand(ICommand newValue)
        {
    ...
    class AntennaFixer : View.ContinuouslyRotating
    {
        public AntennaFixer()
        {
            ...
            SetBinding(RequestEndRotateCommandProperty, new Binding("RequestEndRotateAntennaFixer"));
            changeAngleMouseWheel = 360 / 1 * 0.1;
        }
